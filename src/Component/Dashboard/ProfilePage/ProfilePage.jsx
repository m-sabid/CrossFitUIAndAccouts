...
const ProfilePage = () => {
  ...
  useEffect(()=>{
    http.patch("/update_profile").then((res) => {
      setUpdate(res.data.data);
    });
  }, [])


// console.log("update", update.profile_image);
      ...
      <div className="profileHeader">
            ...
            <div className="name_dis">
              <div className="fname d-flex">
                ...
                <p className="designation">Trainer</p>
              </div>
            </div>
          {/* Acces Level: */}
